...
namespace API.Data.Migrations
{
    ...
    [Migration("20250907191827_GroupsAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.DbGroup", b =>
                {
            ...
            modelBuilder.Entity("API.Entities.DbGroupConnection", b =>
                {
                    b.Property<string>("ConnectionId")
                        .HasColumnType("TEXT");

                    b.Property<string>("DbGroupName")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Entities.DbGroupConnection", b =>
                {
                    b.HasOne("API.Entities.DbGroup", null)
                        .WithMany("Connections")
                        .HasForeignKey("DbGroupName");
                });
